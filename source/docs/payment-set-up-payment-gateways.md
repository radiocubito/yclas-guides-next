...
If you want to create a marketplace and earn commissions per sale, please follow [this guide](/docs/payment-set-up-marketplace-with-srtipe-connect-express)  for more information about Stripe Connect and how it works.
...
With escrow the money gets on hold until the buyer receives the item. To configure Escrow follow  [this guide](/docs/payment-marketplace-with-escrow)
...
You can find more information about 2checkout configuration  [here](/docs/payment-2checkout-configuration)
