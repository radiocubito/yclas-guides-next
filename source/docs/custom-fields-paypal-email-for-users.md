...
1.  [Add an extra field](/docs/custom-fields-create-custom-fields) on the Publish New form.
2.  [Add an extra field](/docs/users-create-custom-field-for-users) on the Users Registration form.
